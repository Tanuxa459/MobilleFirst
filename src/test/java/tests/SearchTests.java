...
public class SearchTests {
    ...
    void successfulSearchTest() throws MalformedURLException, InterruptedException {
        ...
        caps.setCapability("browserstack.user", "pupsik_QLRIcU");
        caps.setCapability("browserstack.key", "buwiXkmUpVkMJ9DsYVVs");

        // Set URL of the application under test
        caps.setCapability("app", "bs://62052639d354aea7139864ba993d1cf6106ef4a3");
